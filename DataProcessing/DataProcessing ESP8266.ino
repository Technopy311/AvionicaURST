...
void loop() {
  ...
  print(SD, "/testing.csv", timechar);
  print(SD, "/testing.csv", "\t");

  print(SD, "/testing.csv", accelX);
  print(SD, "/testing.csv", "\t");
  print(SD, "/testing.csv", accelY);
  print(SD, "/testing.csv", "\t");
  print(SD, "/testing.csv", accelZ);
  print(SD, "/testing.csv", "\t");
  delay(rest_time_ms);
  print(SD, "/testing.csv", gyroX);
  print(SD, "/testing.csv", "\t");
  print(SD, "/testing.csv", gyroY);
  print(SD, "/testing.csv", "\t");
  print(SD, "/testing.csv", gyroZ);
  print(SD, "/testing.csv", "\n");
  delay(rest_time_ms);
